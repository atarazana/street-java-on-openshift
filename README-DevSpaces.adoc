...
[source,sh,attributes]
----
echo "Open: https://$(oc get route myregistry-quay -n quay-system -o jsonpath='{.spec.host}')/${DEV_USERNAME}/${PROJECT_ID}-${ARTIFACT_ID}:${GIT_HASH}"
----
...
skopeo copy --src-tls-verify=false \
  ...
  docker://${REGISTRY}/${DEV_USERNAME}/${PROJECT_ID}-${ARTIFACT_ID}:${GIT_HASH}
----
