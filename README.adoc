...
----
export USERNAME=user4
export PROJECT_NAME=street-java-${USERNAME}
export ADMIN_USER=admin
export PASSWORD=vNSzXZntmmVV4OnW
export SERVER=https://api.cluster-kgbf5.kgbf5.sandbox2412.opentlc.com:6443
...
export USERNAME=user4
export PROJECT_NAME=street-java-${USERNAME}
export PASSWORD=Ci6RgqL0LTGOdS6G
export SERVER=https://api.cluster-kgbf5.kgbf5.sandbox2412.opentlc.com:6443
